...
__all__ = ("AutoSaveDict",)


class AutoSaveDict(dict[Any, Any]):
    def __init__(self, file_path: Optional[os.PathLike[Any]] = None, **pairs: Any):
    ...
    def __or__(self, __value: Mapping[Any, Any]) -> AutoSaveDict:
        data = self._pairs | __value  # type: ignore
    ...
    @classmethod
    def frommapping(
        cls, __mapping: Mapping[Any, Any], file_path: Optional[os.PathLike[Any]] = None
    ) -> AutoSaveDict:
        data = dict(__mapping)
        return cls(file_path, **data)
    ...
    @classmethod
    def fromfile(
        cls, src: os.PathLike[Any], dst: Optional[os.PathLike[Any]] = None
    ) -> AutoSaveDict:
    ...
    def copy(self, file_path: Optional[os.PathLike[Any]] = None) -> AutoSaveDict:
        data = {}
